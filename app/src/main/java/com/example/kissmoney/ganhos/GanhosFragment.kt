 ...
 * Use the [GatnhosFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GatnhosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GatnhosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GatnhosFragment().apply {
